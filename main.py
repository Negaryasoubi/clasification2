...
import decitiontree as abc1
import svm as abc2
import neural as abc3
import randomforest as abc4
import knn as abc5
...
class MyWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # Button 2
        self.button2 = QPushButton('SVM')
        self.button2.setStyleSheet("color : #4682B4 ; font-size: 18px ;background-color: #B0E0E6;")
        self.button2.setFixedSize(150, 75)
        self.button2.clicked.connect(self.run_code_2)
        ...
        # Button 5
        self.button5 = QPushButton('KNN')
        self.button5.setStyleSheet("color : #4682B4 ; font-size: 18px ;background-color: #B0E0E6;")
        self.button5.setFixedSize(150, 75)
        self.button5.clicked.connect(self.run_code_5)
    ...
    def run_code_1(self):
        self.run_script(abc1, "Output of Code 1")

    def run_code_2(self):
        self.run_script(abc2, "Output of Code 2")

    def run_code_3(self):
        self.run_script(abc3, "Output of Code 3")

    def run_code_4(self):
        self.run_script(abc4, "Output of Code 4")

    def run_code_5(self):
        self.run_script(abc5, "Output of Code 5")
